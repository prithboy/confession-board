...
export function PostModal({ onClose, onPost, txStatus, txError, isConnected }) {
  const [text, setText] = useState('')
  const [step, setStep] = useState('write') // write | confirm | done

  const isPosting = txStatus === 'approving' || txStatus === 'posting'
      ...
      >
          ...
          <>
            <div style={{ marginBottom: 20 }}>
              <h2 style={{
                ...
                color: 'var(--arc-text)', marginBottom: 4,
              }}>
                Confess something
              </h2>
              <p style={{
            ...
            {!isConnected ? (
              <div style={{ textAlign: 'center', padding: '20px 0' }}>
                <p style={{ color: 'var(--arc-muted)', fontSize: 14, marginBottom: 20 }}>
                  Connect your wallet to post a confession
                </p>
                <ConnectButton />
              </div>
            ) : (
              <>
                ...
                <div style={{
                  ...
                  <span style={{
                    ...
                    color: text.length > MAX * 0.85 ? 'var(--arc-red)' : 'var(--arc-muted)',
                  }}>
                    {text.length}/{MAX}
                  </span>
        ...
        {step === 'confirm' && (
          <>
            <h2 style={{
              ...
              color: 'var(--arc-text)', marginBottom: 20,
            }}>
            ...
            <div style={{
              ...
              {[
                ['Post fee', '$0.10 USDC'],
                ['Goes to weekly pool', '✓'],
                ['Author address stored', '✓ (anonymous)'],
            ...
            {txError && (
              <div style={{
                ...
                border: '1px solid rgba(232,91,122,0.2)',
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              <button
                ...
                style={{
                  ...
                  color: 'var(--arc-muted)', fontSize: 13,
                  transition: 'all 0.15s',
                }}
              >
                ← Back
        ...
        {step === 'done' && (
          <div style={{ textAlign: 'center', padding: '20px 0' }}>
            ...
            <h2 style={{
              fontFamily: 'var(--font-serif)', fontStyle: 'italic',
              fontSize: 22, fontWeight: 400, color: 'var(--arc-text)',
              marginBottom: 8,
            }}>
              Confession recorded
            </h2>
            <p style={{
              fontSize: 12, fontFamily: 'var(--font-mono)',
              color: 'var(--arc-muted)', marginBottom: 28,
            }}>
            ...
            <button
              onClick={onClose}
              style={{
                background: 'var(--arc-blue)', border: 'none',
